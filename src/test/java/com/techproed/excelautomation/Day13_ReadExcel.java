...
//      Data type usaCell Cell. I can convert this to a string to using string manipulation, lowercase, substring,charAt,...
...
//            System.out.println("CAPITOL : "+sheet.getRow(rowNumber).getCell(capitolColumn));//capitol
            String counties=sheet.getRow(rowNumber).getCell(countryColumn).toString();
            String capitols=sheet.getRow(rowNumber).getCell(capitolColumn).toString();
            worldCapitals.put(counties,capitols);
        }
